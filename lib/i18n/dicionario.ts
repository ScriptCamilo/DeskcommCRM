...
export const DICIONARIO: Traducoes = {
  ...
  // ─── Marca da instalação e recuperação do convite do responsável ───
  "Email de suporte": { es: "Correo de soporte" },
  ...
  "Convite do responsável reenviado por e-mail.": {
    es: "Invitación del responsable reenviada por correo electrónico.",
  },
  "O e-mail não saiu. Use o novo link de convite abaixo.": {
    es: "El correo no se envió. Usa el nuevo enlace de invitación que aparece abajo.",
  },
  "Não foi possível copiar. Selecione o link abaixo.": {
    es: "No se pudo copiar. Selecciona el enlace que aparece abajo.",
  },
  ...
  "Link do convite do responsável": { es: "Enlace de invitación del responsable" },
};
